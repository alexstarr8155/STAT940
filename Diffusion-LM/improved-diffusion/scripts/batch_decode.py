...
for lst in full_lst:
    ...
    COMMAND = f'python3 scripts/{mode}_sample.py ' \
...
#     elif modality == 'e2e':
#         COMMAND1 = f"python3 diffusion_lm/e2e_data/mbr.py {out_path2}"

#         os.system(COMMAND1)
#         COMMAND2 = f"python3 e2e-metrics/measure_scores.py " \
...
#         continue
#     COMMAND = f"python3 scripts/ppl_under_ar.py " \
#               f"--model_path {tgt} " \
